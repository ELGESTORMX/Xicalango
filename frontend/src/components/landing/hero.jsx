  ...
  return (
    <section className=''>
      <div className="h-20"></div>
        <div className="relative flex flex-col px-4 items-center justify-center h-[50vh] bg-cover bg-center bg-no-repeat text-white" 
            ...
            <div className="relative z-10 text-center">
                ...
                <a href='#servicios' className="bg-white text-[#6FAD46] font-bold px-6 py-2 rounded-full hover:bg-gray-200 transition duration-300">
                 Solicita tu cotización sin cargo
                </a>
            </div>
        </div>
    </section>
