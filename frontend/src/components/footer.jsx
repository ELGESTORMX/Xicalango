          ...
          <div className='grid md:grid-cols-3 gap-6 text-center'>
            ...
            <div className='flex items-center justify-center md:justify-start text-white'>
              ...
              <div className='text-left'>
                ...
                <p className='text-sm text-white'>938 255 0290</p>
              </div>
            </div>
            ...
            <div className='flex items-center justify-center md:justify-start text-white'>
              ...
              <div className='text-left'>
                ...
                <p className='text-sm text-white'>info@xicalango.com</p>
              </div>
            </div>
            ...
            <div className='flex items-center justify-center md:justify-start text-white'>
              ...
              <div className='text-left'>
                ...
                <p className='text-sm text-white'>Lun-Vie: 8AM-6PM</p>
              </div>
            </div>
          </div>
        </div>
