...
export default function footer() {
  return (
    <footer className='bg-gray-900 text-white'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='lg:col-span-2'>
            <div className='flex items-center mb-4'>
              <img src={logo} alt="Xicalango Logo" className='h-[150px] w-auto object-contain mr-4' />
            </div>
          ...
          <div>
            ...
            <div className='space-y-4 mb-6'>
              <div className='flex items-center text-gray-300'>
                <svg className='w-5 h-5 mr-3 text-[#6FAD46]' fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span className='text-sm'>938 255 0290</span>
              </div>
              ...
              <div className='flex items-center text-gray-300'>
                ...
                <span className='text-sm'>info@xicalango.com</span>
              </div>
            ...
            {/* Redes sociales */}
            <div>
              <h5 className='text-md font-semibold mb-3 text-white'>Síguenos en nuestras redes</h5>
              <div className='flex space-x-3'>
                <a target='_blank' href="https://www.facebook.com/profile.php?id=61575982845011" className='w-10 h-10 bg-[#6FAD46] rounded-full flex items-center justify-center hover:bg-[#5a9639] transition-colors duration-300'>
      ...
      {/* Copyright */}
      <div className='bg-gradient-to-r from-[#6FAD46] to-gray-800 border-t border-gray-700 py-6'>
